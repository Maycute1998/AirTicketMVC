...
namespace MvcEfCore.Areas.Admin.Controllers
{
    ...
    public class LichChuyenBaysController : Controller
    {
        ...
        [Route("create")]
        public async Task<IActionResult> Create(int?[] ThoiGianDung, string[] TramDung, string[] GhiChu, string SanBayDi, string SanBayDen, [Bind("ChuyenBayID,NgayGioBay,GiaVe,ThoiGianBay,SoGheHang1,SoGheHang2")] LichChuyenBay lichChuyenBay)
        {
        ...
        public async Task<IActionResult> Edit(string ChuyenBayID, [Bind("ChuyenBayID,NgayGioBay,GiaVe,ThoiGianBay,SoGheHang1,SoGheHang2")] LichChuyenBay lichChuyenBay)
        {
