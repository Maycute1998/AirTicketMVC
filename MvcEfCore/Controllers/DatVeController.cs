    ...
    public class DatVeController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            foreach (var chuyenBay in ChuyenBay)
            {
                ...
                if ((ghe01 == null || ghe01.Count() == 0) && chuyenBayVM[dem].SoGheHang1 == 0)
                {
                    chuyenBayVM[dem].SoGheHang1 = chuyenBay.SoGheHang1;
                }
                else chuyenBayVM[dem].SoGheHang1 = chuyenBay.SoGheHang1 - ghe01.Count();

                var ghe02 = _context.PhieuDatVes.Where(p => p.ChuyenBayID == chuyenBay.ChuyenBayID && p.HangID == "HA02");
                if ((ghe02 == null || ghe02.Count() == 0) && chuyenBayVM[dem].SoGheHang1 == 0)
                {
                    chuyenBayVM[dem].SoGheHang2 = chuyenBay.SoGheHang2;
                }
                else chuyenBayVM[dem].SoGheHang2 = chuyenBay.SoGheHang2 - ghe02.Count();

                var datCho01 = _context.PhieuDatChos.Where(p => p.ChuyenBayID == chuyenBay.ChuyenBayID && p.HangID == "HA01");
                if ((datCho01 == null || datCho01.Count() == 0) &&  chuyenBayVM[dem].SoGheHang1 == 0)
                {
                    chuyenBayVM[dem].SoGheHang1 = chuyenBay.SoGheHang1;
                }
                else chuyenBayVM[dem].SoGheHang1 = chuyenBayVM[dem].SoGheHang1 - datCho01.Count();
                ...
                else chuyenBayVM[dem].SoGheHang2 = chuyenBayVM[dem].SoGheHang2 - datCho02.Count();
                dem++;
            }
